...
Route::get('/send-news-letter/{id}', 'HomeController@sendNewsLetter')->name('send.to');
/*Admin routes Start*/
...
Route::get('job-applicants/{id}','ApplicantsController@index')->name('list-applicants');
Route::get('applicant-profile/{id}','ApplicantsController@ApplicantProfile')->name('applicant-profile');
Route::get('fetch-applicants-data','ApplicantController@fetchApplicantData')->name('applicant.data.fetch');
Route::get('applicants-data','ApplicantController@index')->name('applicants-data');

Route::get('/login-as-student/{id}', 'StudentController@student_home')->name('login.as.student');
Route::get('/login-as-applicant/{id}', 'ApplicantsController@applicant_home')->name('login.as.applicant');
...
Route::get('/students-data', 'StudentController@fetchStudentData')->name('students.data.fetch');
...
Route::get('/student-status/{student}/{status}', 'StudentController@update_status');

Route::get('/edit-student/{student}', 'StudentController@edit')->name('students.edit');

Route::get('/delete-student/{student}', 'StudentController@destroy')->name('students.delete');

Route::get('/delete-applicant/{applicant}', 'ApplicantController@destroy')->name('applicant.delete');
...
Route::get('/module-data', 'ModulesDataController@fetchModulesData')->name('modules.data.fetch');
