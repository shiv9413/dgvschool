...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} :: Applicant</title>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ route('applicant.home') }}">
                {{ config('app.name', 'Laravel') }} :: Applicant
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @if (Auth::guard('applicant')->guest())
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('applicant.login') }}">{{ __('Login') }}</a>
                        </li>
                        @if (Route::has('applicant.register'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('applicant.register') }}">{{ __('Register') }}</a>
                            </li>
                        @endif
                    @else
