    ...
    <div class="login-wrap ">
      <div class="contact-info login_box">
        ...
        <div class="form-group">
          <a href="{{route('applicant.register')}}" class="default-btn btn send_btn">Create Account <span></span></a>
        </div>
        <div class="contact-form loginWrp">
          <h3>Login Applicant</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          <form method="POST" action="{{ route('applicant.login') }}" aria-label="{{ __('Login') }}" id="contactForm" novalidate="">
            @csrf
            <div class="row">
              ...
              <div class="col-lg-12 col-md-12">
                ...
                <div class="form-group">
                  <div class="forgot_password">
                    @if (Route::has('applicant.password.request'))
