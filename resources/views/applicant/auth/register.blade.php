  ...
  <div class="container"> 
    ...
    <div class="login-wrap ">
      <div class="contact-info login_box">
        ...
        <form id="contactForm" novalidate="" method="POST" action="{{ route('applicant.register') }}">
                        @csrf
            <div class="form_set">
            ...
            <div class="form-group">
              <div class="already_account">Already have Account? <a href="{{route('applicant.login')}}">Login</a></div>
            </div>
          </form>
        </div>
      </div>
