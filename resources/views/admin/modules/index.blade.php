            ...
            <div class="page-header">
               ...
               <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                     ...
                     <li class="breadcrumb-item">Modules
                     </li>
                           ...
                           <div class="table-responsive">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <a class="btn btn-success" href="{{route('admin.modules.edit',$module->id)}}" role="button">Edit</a>
                                       <a class="btn btn-danger delete" href="{{route('admin.modules.delete',$module->id)}}" role="button">Delete</a>
                                    </td>
                                 </tr>
                                 @endforeach
                                 @endif
