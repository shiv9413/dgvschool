            ...
            <div class="page-header">
               ...
               <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                     ...
                     <li class="breadcrumb-item"><a href="#!">{{__('Applicants List')}}</a>
                     </li>
                     <li class="breadcrumb-item"><a href="#!">{{__('Applicants List')}}</a>
                     </li>
                  </ul>
                        ...
                        <div class="card-block">
                           <div class="dt-responsive table-responsive">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    <td style="width:10%">
                                        <img width="100%" src="{{asset('images/'.$applicant->seeker->attached_file)}}">
                                        
                                    </td>
                                    <td>{{$applicant->seeker->name}}</td>
                                    <td>
                                      {{$applicant->job->title}}  
                                    </td>
                                    <td>
                                        <a href="{{route('admin.applicant-profile',$applicant->user_id)}}" class="btn btn-primary">View Detail</a><a href="{{route('admin.applicant-profile',$applicant->user_id)}}" class="btn btn-primary">Login as Applicant</a>
                                    </td>
