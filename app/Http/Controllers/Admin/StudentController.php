    ...
    public function fetchStudentData(Request $request)
    {
        ...
        return Datatables::of($students)
                        ...
                        ->addColumn('action', function ($students) {
                            $action = '<a target="_blank" href="'.route('admin.login.as.student',[$students->id]).'" class="tabledit-edit-button btn btn-primary waves-effect waves-light" style="float: none;margin: 5px; font-size: 12px;"><span class="icofont icofont-ui-edit"></span>&nbsp Login as Student</a><a href="'.route('admin.students.edit',[$students->id]).'" class="tabledit-edit-button btn btn-primary waves-effect waves-light" style="float: none;margin: 5px; font-size: 12px;"><span class="icofont icofont-ui-edit"></span>&nbsp Edit</a>
